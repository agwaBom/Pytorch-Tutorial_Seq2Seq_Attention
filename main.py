...
def train(input_tensor, target_tensor, encoder, decoder, encoder_optimizer, decoder_optimizer, criterion, max_length=p.MAX_LENGTH):
...
def evaluate(encoder, decoder, sentence, max_length=p.MAX_LENGTH):
    with torch.no_grad():
